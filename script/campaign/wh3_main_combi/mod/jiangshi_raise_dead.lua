...
local jiangshi_region_index = {
    ...
    "wh3_main_combi_region_zvorak",  --- Added a trailing comma just for good practice -UlrikHD
}
...
local function raise_dead_setup()
    -- Populating at start all regions
    core:add_listener(
        "jiangshi_raise_dead_StartPopulation",  --- Changed listener name to something more unique -UlrikHD
        "CharacterTurnStart",
        true,
        function()  --- Removed context input that isn't used -UlrikHD
            for i = 1, #jiangshi_region_index do
                cm:add_unit_to_province_mercenary_pool(
                    cm:get_region(jiangshi_region_index[i]),
